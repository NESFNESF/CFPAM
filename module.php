                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>Module</li>
                                        <li class="active">Liste des modules</li>
                                    </ul>
                                </div>
...
<td><?php echo htmlentities($cnt);?></td>
            <td><?php echo htmlentities($c['Nom_Module']);?></td>
            <td><?php  $id = $c['idfiliere'];
                                $q="select nofiliere from filiere where idfiliere ='$id' ";
                                $s = $dbh -> query($q);
                                $a = $s->fetch();
