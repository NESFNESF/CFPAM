                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblstudents.nom,tblstudents.prenom,tblstudents.sexe,tblstudents.date,tblstudents.lieu,tblstudents.montant,tblstudents.filiere from tblstudents";
