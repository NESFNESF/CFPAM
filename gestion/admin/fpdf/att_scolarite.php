...
$pdf->Write($h, "Je soussigné, Directeur du Centre de Formation Professionnel des Arts et Metiers abregé CFPAM Certifie que : \n");
...
$pdf->Write($h, "Poursuit ses étude dans la  " . $filiere . "   et cela pour l'année scolaire en cours  " . $as . "  \n");

$pdf->Write($h, "La présente attestation est délivrée à l'intéressé Pour servir et valoir ce que de droit. \n");

$pdf->Cell(0, 5, 'Fait au CFPAM Le :' . date('d/m/Y'), 0, 1, 'C');

// Décalage de 20 mm à droite
$pdf->Cell(20);
$pdf->Cell(80, 8, "Le directeur du CFPAM", 1, 1, 'C');

// Décalage de 20 mm à droite
$pdf->Cell(20);
$pdf->Cell(80, 5, "Mr TATKEU JOB", 'LR', 1, 'C');
$pdf->Cell(20);
