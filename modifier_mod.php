...
if(isset($_POST['btn']))
{
 ...
 }else
 {
  ...
  $sql2 = "INSERT INTO module(Nom_module , idFiliere,temps) VALUES ('$module','$filiere','$temps')"; 
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Ajouter d'un module</h2>
    ...
    <div class="container col-md-6 col-md-offset-3 space">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                    ...
                    $id = $_GET['id'] ;
                    $sql1 =" SELECT * FROM module WHERE Num_Module = '$id' ";
                    $tab=$dbh->exec($sql1);
                    $tab = $tab[0];
              ...
              <div class="form-group" >
                   <div class="input-group">
                   <div class="input-group-addon"><span class="glyphicon glyphicon-list-alt"></span></div>
                   <input name="temps"  class="form-control" type="number" placeholder="durée du module">
                   </div>
                   <span class="help-block" id="error"></span>
              </div>
                      <div class="form-group ">
