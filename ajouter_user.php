...
$sql="INSERT INTO  user(nom,prenom,sexe,date_naissance,lieu_de_naissance,email,login,password,contact,role) VALUES(:nom,:prenom,:sexe,:date,:lieu,:email,:login,:password,:contact,:role)";
        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                     ...
                     <div class="form-group">
                        ...
                        <input type="email" name="prenom" class="form-control" required>
                     </div>
                     <div class="form-group">
