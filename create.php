            	...
            	<table class="table table-hover">
					...
					<tr>
						...
						<th>Action</th>
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT user.name,user.pass,user.type from user";
...
<tr>
 <td><?php echo htmlentities($cnt);?></td>
							...
							<?php 
						echo "<a href=\"modifier_user.php?id=".$results['id']."\" class=\"btn btn-warning\">Modifier</span>" ;
							?>
							</td>
							<td style = "text-align:center;"> 
							<?php 
			...
			echo "<a href=\"supprimer_user.php?id=".$results['id']."\" class=\"btn btn-danger\">Supprimer</span>" ;
